/**
 * Cross-domain GRC search aggregator.
 *
 * Owned by integration-service because it fans out across all domain tables —
 * it is inherently a cross-cutting aggregation concern, not specific to any one
 * domain service.  The gateway proxies /api/search here.
 */
