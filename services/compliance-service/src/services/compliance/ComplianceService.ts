...
const FRAMEWORK_REGISTRY: FrameworkRegistryEntry[] = [
  { id:"iso27001", name:"ISO 27001:2022",     version:"2022", category:"Security",    totalControls:114, pct:78, trend:"up",   color:"#1E3A5F", scope:"Full ISMS",             owner:"Priya Lee",     nextReview:"2024-10-14", criticalGaps:["A.12.6.1 Vulnerability Mgmt","A.13.1 Network Controls"] },
  { id:"soc2",     name:"SOC 2 Type II",      version:"2017", category:"Security",    totalControls:64,  pct:81, trend:"up",   color:"#065F46", scope:"Trust Services",        owner:"Marcus Johnson",nextReview:"2024-09-30", criticalGaps:["CC7.1 System Monitoring"] },
  { id:"gdpr",     name:"GDPR",               version:"2018", category:"Privacy",     totalControls:25,  pct:68, trend:"up",   color:"#4338CA", scope:"Data Processing",       owner:"Emma Wilson",   nextReview:"2024-07-15", criticalGaps:["Art.32 Security of Processing","Art.35 DPIA"] },
  { id:"hipaa",    name:"HIPAA",              version:"2013", category:"Healthcare",  totalControls:45,  pct:84, trend:"flat", color:"#92400E", scope:"ePHI Systems",          owner:"Ryan Johnson",  nextReview:"2024-07-01", criticalGaps:["164.312(b) Audit Controls"] },
  { id:"nis2",     name:"NIS2 Directive",     version:"2022", category:"Regulatory",  totalControls:21,  pct:38, trend:"up",   color:"#0C4A6E", scope:"Essential Services",    owner:"Maria Santos",  nextReview:"2024-08-20", criticalGaps:["Art.21 Risk Measures","Art.23 Incident Reporting","Art.24 ICT Standards"] },
  { id:"pcidss",   name:"PCI DSS v4.0",       version:"4.0",  category:"Payment",     totalControls:78,  pct:78, trend:"up",   color:"#B45309", scope:"Cardholder Data",       owner:"Alex Kim",      nextReview:"2024-09-15", criticalGaps:["Req 6.3 Security Vulnerabilities","Req 10.2 Audit Logs"] },
  { id:"nistcsf",  name:"NIST CSF v2.0",      version:"2.0",  category:"Security",    totalControls:108, pct:67, trend:"up",   color:"#1D4ED8", scope:"Critical Infrastructure",owner:"Priya Lee",     nextReview:"2024-11-01", criticalGaps:["DE.AE Anomaly Detection","RS.MI Incident Mitigation"] },
  ...
  { id:"iso22301", name:"ISO 22301:2019",     version:"2019", category:"BCP",         totalControls:34,  pct:61, trend:"up",   color:"#7C3AED", scope:"BCM Programme",         owner:"Alex Kim",      nextReview:"2024-12-01", criticalGaps:["8.4.2 BIA","8.4.3 Business Continuity Plans"] },
  { id:"dora",     name:"DORA",               version:"2022", category:"Regulatory",  totalControls:46,  pct:44, trend:"up",   color:"#9D174D", scope:"Financial ICT Risk",    owner:"Emma Wilson",   nextReview:"2025-01-17", criticalGaps:["Art.5 ICT Risk Framework","Art.11 ICT BC Policy","Art.17 ICT Incident Response"] },
  { id:"sama",     name:"SAMA CSF",           version:"2017", category:"Financial",   totalControls:85,  pct:55, trend:"flat", color:"#065F46", scope:"Banking & Insurance",   owner:"Maria Santos",  nextReview:"2025-01-01", criticalGaps:["3.3 Compliance","4.2 HR","4.3 Operations"] },
  { id:"swift",    name:"SWIFT CSCF",         version:"2024", category:"Financial",   totalControls:32,  pct:91, trend:"up",   color:"#1E3A5F", scope:"SWIFT Messaging",       owner:"Ryan Johnson",  nextReview:"2025-01-01", criticalGaps:[] },
  { id:"cmmc",     name:"CMMC 2.0 Level 2",   version:"2.0",  category:"Defense",     totalControls:110, pct:48, trend:"up",   color:"#7C3AED", scope:"Defense Contracts",     owner:"Alex Kim",      nextReview:"2025-06-01", criticalGaps:["SI Security Integrity","IR Incident Response","MA Maintenance"] },
  { id:"euaiact",  name:"EU AI Act",          version:"2024", category:"AI",          totalControls:18,  pct:31, trend:"up",   color:"#4338CA", scope:"High-Risk AI Systems",  owner:"Emma Wilson",   nextReview:"2025-08-02", criticalGaps:["Art.9 Risk Management","Art.10 Data Governance","Art.17 Quality Management"] },
  { id:"iso42001", name:"ISO 42001:2023",     version:"2023", category:"AI",          totalControls:26,  pct:27, trend:"up",   color:"#0891B2", scope:"AI Management System",  owner:"Priya Lee",     nextReview:"2025-01-01", criticalGaps:["Annex A AI Risk","Annex B AI Impact"] },
  { id:"fedramp",  name:"FedRAMP Moderate",   version:"2024", category:"Government",  totalControls:325, pct:52, trend:"flat", color:"#DC2626", scope:"Federal Cloud Systems", owner:"Marcus Johnson",nextReview:"2025-03-01", criticalGaps:["AC-2 Account Mgmt","SI-2 Flaw Remediation","IR-4 Incident Handling"] },
  { id:"iso31000", name:"ISO 31000:2018",     version:"2018", category:"Risk",        totalControls:22,  pct:73, trend:"up",   color:"#065F46", scope:"Enterprise Risk",       owner:"Maria Santos",  nextReview:"2024-12-01", criticalGaps:["6.5 Monitoring","6.7 Communication"] },
  { id:"csa",      name:"CSA CCM v4.0",       version:"4.0",  category:"Cloud",       totalControls:197, pct:59, trend:"up",   color:"#0C4A6E", scope:"Cloud Infrastructure",  owner:"Alex Kim",      nextReview:"2024-11-15", criticalGaps:["IVS-06 Network Security","IAM-01 Identity","LOG-08 Audit Logging"] },
  { id:"ccpa",     name:"CCPA / CPRA",        version:"2023", category:"Privacy",     totalControls:20,  pct:74, trend:"flat", color:"#7C3AED", scope:"California Consumers",  owner:"Emma Wilson",   nextReview:"2025-01-01", criticalGaps:["Right to Opt-Out of Sale","Sensitive PI Processing"] },
  { id:"iso27701", name:"ISO 27701:2019",     version:"2019", category:"Privacy",     totalControls:49,  pct:62, trend:"up",   color:"#9D174D", scope:"Privacy Info Mgmt",     owner:"Priya Lee",     nextReview:"2024-09-01", criticalGaps:["7.2.1 PIMS-specific Controls","7.4.8 PII Disclosure"] },
];
