...
const FRAMEWORK_SEED: Array<{
  ...
  // India
  { shortCode:"CERTIN-2022", name:"CERT-In Directions 2022",                    version:"2022", category:"Regional Financial", region:"APAC",   controlsCount:30,  isBeta:false, description:"Indian Computer Emergency Response Team Directions — mandatory 6-hour incident reporting, 180-day log retention, synchronised clocks and VPN subscriber records." },

  // Saudi Arabia (KSA)
  { shortCode:"NCA-ECC",     name:"NCA Essential Cybersecurity Controls (KSA)",  version:"2020", category:"Regional Financial", region:"MENA",   controlsCount:60,  isBeta:false, description:"National Cybersecurity Authority Essential Controls — baseline requirements across Governance, Defence, Resilience and Third-Party domains for Saudi entities." },
  { shortCode:"NCA-CCC",     name:"NCA Cloud Cybersecurity Controls (KSA)",      version:"2020", category:"Regional Financial", region:"MENA",   controlsCount:40,  isBeta:false, description:"NCA Cloud Cybersecurity Controls — governance, data sovereignty, identity and network security controls for Saudi organisations consuming cloud services." },

  // Bahrain
  { shortCode:"CBB-CS",      name:"CBB Cybersecurity Framework (Bahrain)",       version:"2019", category:"Regional Financial", region:"MENA",   controlsCount:50,  isBeta:false, description:"Central Bank of Bahrain Cybersecurity Module — governance, ICT risk, access controls, incident response and outsourcing requirements for CBB licensees." },
  { shortCode:"BH-PDPL",     name:"Bahrain PDPL",                                version:"2018", category:"Privacy",           region:"MENA",   controlsCount:25,  isBeta:false, description:"Bahrain Personal Data Protection Law — data controller PDPEA registration, consent, data subject rights, cross-border transfers and breach notification." },

  // Australia
  { shortCode:"ASD-E8",      name:"ASD Essential Eight",                         version:"2023", category:"Industry",          region:"APAC",   controlsCount:40,  isBeta:false, description:"Australian Signals Directorate Essential Eight Maturity Model — 8 baseline mitigation strategies at 4 maturity levels for Australian organisations." },
  { shortCode:"AU-ISM",      name:"Australian Government ISM",                   version:"2024", category:"Defense",           region:"APAC",   controlsCount:80,  isBeta:false, description:"Australian Government Information Security Manual — risk-based controls for government agencies and technology partners across all security domains." },

  // UAE
  { shortCode:"UAE-NESA",    name:"UAE NESA IA Standards",                       version:"2014", category:"Regional Financial", region:"MENA",   controlsCount:60,  isBeta:false, description:"UAE National Electronic Security Authority Information Assurance Standards — governance, risk, access control and incident management for UAE critical infrastructure." },
  { shortCode:"DIFC-DP",     name:"DIFC Data Protection Law 2020",               version:"2020", category:"Privacy",           region:"MENA",   controlsCount:35,  isBeta:false, description:"DIFC Data Protection Law 2020 — data controller and processor obligations, consent, data subject rights, cross-border transfers and 72-hour breach notification." },

  // Kenya
  { shortCode:"CBK-CS",      name:"CBK Cybersecurity Guidance (Kenya)",          version:"2021", category:"Regional Financial", region:"Africa", controlsCount:40,  isBeta:false, description:"Central Bank of Kenya Cybersecurity Guidance — ICT risk governance, access control, incident response and 24-hour reporting for CBK-licensed institutions." },
];
...
export async function seedFrameworkLibrary(): Promise<void> {
  ...
  seedRan = true;
  try {
    // Always upsert — onConflictDoNothing handles existing entries so new frameworks are safely added
...
router.post("/admin/frameworks/:id/tenants", requireAuth, isSuperAdmin, async (req, res) => {
  try {
    const frameworkId = parseInt(String(req.params["id"] ?? ""), 10);
    const actor = u(req);
